 ...
 */
public class InvoiceProductItemImpl extends AbstractPersistentObject implements InvoiceProductItem {
	...
	public InvoiceProductItemImpl(String id, Product product, int measureOkeiCode,
